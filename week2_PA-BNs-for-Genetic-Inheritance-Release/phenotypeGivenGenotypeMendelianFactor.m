...
if isDominant,phenotypeFactor.val = +((Assignment(:,1)==1&Assignment(:,2)~=3)|(Assignment(:,1)==2&Assignment(:,2)==3));
else phenotypeFactor.val = +((Assignment(:,1)==1&Assignment(:,2)==3)|(Assignment(:,1)==2&Assignment(:,2)~=3));
end
