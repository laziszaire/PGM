...
for i = 1:size(assignments,1)
    ...
    p = fp(assignment,allelesToGenotypes,alphaList);
    phenotypeFactor = SetValueOfAssignment(phenotypeFactor,assignment,p);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
end

function p = fp(assignment,allelesToGenotypes,alphaList)
[have,allele1,allele2] = deal(assignment(1),assignment(2),assignment(3));
