...
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,Assignment(Assignment(:,1)==1,:),alphaList);
phenotypeFactor = SetValueOfAssignment(phenotypeFactor,Assignment(Assignment(:,1)~=1,:),1-alphaList);
